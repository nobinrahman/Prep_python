...
class SWAN_Convergence_UCMPv4_4k_Node1(aetest.Testcase):
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28000 shutdown",
                                            "interface Bundle-Ether 28001 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28000 shutdown",
                                            "no interface Bundle-Ether 28001 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28002 shutdown",
                                            "interface Bundle-Ether 28003 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28002 shutdown",
                                            "no interface Bundle-Ether 28003 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['sste_commands'] = ["interface Bundle-Ether 28000 shutdown",
                                            "interface Bundle-Ether 28001 shutdown",
                                            "interface Bundle-Ether 28002 shutdown",
                                            "interface Bundle-Ether 28003 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['sste_commands'] = ["no interface Bundle-Ether 28000 shutdown",
                                            "no interface Bundle-Ether 28001 shutdown",
                                            "no interface Bundle-Ether 28002 shutdown",
                                            "no interface Bundle-Ether 28003 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data = [["HOP Away class-default path(NonCBF->Non CBF)","Shut", DBF1, DWF1, SBF1, SWF1, Aggrigate1], 
            ["HOP Away class-default path(NonCBF->Non CBF)","NoShut", DBF2, DWF2, SBF2, SWF2, Aggrigate2], 
            ["HOP Away class-scavenger path(NonCBF->Non CBF)","Shut", DBF7, DWF7, SBF7, SWF7, Aggrigate7],
            ["HOP Away class-scavenger path(NonCBF->Non CBF)","NoShut", DBF8, DWF8, SBF8, SWF8, Aggrigate8], 
            ["HOP Away both classes paths(NonCBF->Non CBF)","Shut", DBF13, DWF13, SBF13, SWF13, Aggrigate13], 
            ["HOP Away both classes paths(NonCBF->Non CBF)","NoShut", DBF14, DWF14, SBF14, SWF14, Aggrigate14]
            ]
            ...
            log.info(banner("UCMP HOP Away Node SWAN Convergence"))
            log.info(table_grid)
