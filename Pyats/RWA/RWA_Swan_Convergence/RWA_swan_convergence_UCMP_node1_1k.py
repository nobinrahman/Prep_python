...
class SWAN_Convergence_UCMPv4_4k_Node1(aetest.Testcase):
    global coredump_list, showtech_list, interface_list
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        for loop in range(int(self.loop)):
            ...
            self.controller.execute('gzip -c /root/MBB_MASTER/MIXED/UCMP/OWR1/OWR1_D8WAN_SLICE_UCMP.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')            
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 12800 shutdown"]
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["show mpls forwarding labels 34000 35999",
                                            "show mpls forwarding labels 44000 45999",
                                            "show mpls forwarding labels 34000 35999 | in BE | utility wc lines",
                                            "show mpls forwarding labels 44000 45999 | in BE | utility wc lines",
                                            "show mpls forwarding labels 74000 75999",
                                            "show mpls forwarding labels 84000 85999"]
            output = sste_common.exec_commands(module_args, script_args)
            ...
            self.D8W.execute('show mpls forwarding labels 54000 55999', timeout = 300)
            self.D8W.execute('show mpls forwarding labels 64000 65999', timeout = 300)
            self.D8W.execute('show mpls forwarding labels 54000 55999 | in BE | utility wc lines', timeout = 300)
            self.D8W.execute('show mpls forwarding labels 64000 65999 | in BE | utility wc lines', timeout = 300)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 12800 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 12801 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 12801 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 12800 shutdown",
                                            "interface Bundle-Ether 12801 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 12800 shutdown",
                                            "no interface Bundle-Ether 12801 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 12802 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 12802 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 12803 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 12803 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 12802 shutdown",
                                            "interface Bundle-Ether 12803 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 12802 shutdown",
                                            "no interface Bundle-Ether 12803 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['sste_commands'] = ["interface Bundle-Ether 12800 shutdown",
                                            "interface Bundle-Ether 12801 shutdown",
                                            "interface Bundle-Ether 12802 shutdown",
                                            "interface Bundle-Ether 12803 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args['sste_commands'] = ["no interface Bundle-Ether 12800 shutdown",
                                            "no interface Bundle-Ether 12801 shutdown",
                                            "no interface Bundle-Ether 12802 shutdown",
                                            "no interface Bundle-Ether 12803 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data = [["RWA Class-default single path (CBF->Non CBF)","Shut", DBF1, DWF1, SBF1, SWF1, Aggrigate1], 
            ["RWA Class-default single path (CBF->Non CBF)","NoShut", DBF2, DWF2, SBF2, SWF2, Aggrigate2],
            ["RWA Class-default both paths(CBF->Non CBF)","Shut", DBF5, DWF5, SBF5, SWF5, Aggrigate5], 
            ["RWA Class-default both paths(CBF->Non CBF)","NoShut", DBF6, DWF6, SBF6, SWF6, Aggrigate6], 
            ["RWA Class-scavenger single path (CBF->Non CBF)", "Shut", DBF7, DWF7, SBF7, SWF7, Aggrigate7],
            ["RWA Class-scavenger single path (CBF->Non CBF)","NoShut", DBF8, DWF8, SBF8, SWF8, Aggrigate8], 
            ["RWA Class-scavenger both paths (CBF->Non CBF)","Shut", DBF11, DWF11, SBF11, SWF11, Aggrigate11],
            ["RWA Class-scavenger both paths (CBF->Non CBF)","NoShut", DBF12, DWF12, SBF12, SWF12, Aggrigate12], 
            ["RWA all paths for both classes(CBF->Non CBF)","Shut", DBF13, DWF13, SBF13, SWF13, Aggrigate13], 
            ["RWA all paths for both classes(CBF->Non CBF)","NoShut", DBF14, DWF14, SBF14, SWF14, Aggrigate14]
            ]
            ...
            log.info(banner("UCMP RWA Node SWAN Convergence"))
            log.info(table_grid)
