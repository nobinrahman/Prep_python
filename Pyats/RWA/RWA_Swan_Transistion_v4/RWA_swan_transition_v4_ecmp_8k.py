...
def V4_Controller(failed, steps, script_args, testscript, testbed, test_data, timing):
    ...
    controller.execute('gzip -c /root/CBF_Only/734-40/OWR-734-50/D18-4NH-1000CBF-V4+V6-V4-ECMP.xml | curl -s -X POST http://172.25.124.54:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;', timeout = 300)
    time.sleep(2)
    ...
    time.sleep(2)
    controller.execute('gzip -c /root/MBB_MASTER/MIXED/ECMP/OWR1/OWR1_D8WAN_SLICE_ECMP_V4V6NH_8K.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;', timeout = 300)
    time.sleep(60)
...
def V6_Controller(failed, steps, script_args, testscript, testbed, test_data, timing):
    ...
    controller.execute('gzip -c /root/CBF_Only/734-40/OWR-734-50/D18-4NH-1000CBF-V4+V6-V4-ECMP.xml | curl -s -X POST http://172.25.124.54:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')
    time.sleep(2)
    ...
    time.sleep(2)
    controller.execute('gzip -c /root/MBB_MASTER/MIXED/ECMP/OWR1/OWR1_D8WAN_SLICE_ECMP_V4V6NH_8K.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')
    time.sleep(60)
    controller.disconnect()
...
def Verifier_Before(failed, steps, script_args, testscript, testbed, test_data, timing):
    ...
    log.info(banner("Checking 8k Labels"))
    counter = 0
    while 1:
...
class TC2_CONTINUOUS_SWAN_PROGRAMMING(aetest.Testcase):
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        for beloop in range(int(self.beloop)):
            ...
            self.controller.execute('gzip -c /root/CBF_Only/734-40/OWR-734-50/D18-4NH-1000CBF-V4+V6-V4-ECMP.xml | curl -s -X POST http://172.25.124.54:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;', timeout = 300)
            time.sleep(1)
            ...
            time.sleep(1)
            self.controller.execute('gzip -c /root/MBB_MASTER/MIXED/ECMP/OWR1/OWR1_D8WAN_SLICE_ECMP_V4V6NH_8K.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;', timeout = 300)
            time.sleep(1)
...
#                            log.failed('connect failed')
                ...
                output = self.D18WAN.execute('show cef ipv4 100.250.104.99/32 detail loca 0/0/cpu0', timeout = 300)
                #
                #
                #
