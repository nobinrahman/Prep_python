...
#
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_NH","No Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Primary_4NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Primary_4NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_4NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_4NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_4NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_4NH","NoShut"] + get_values_swan(test_data))
