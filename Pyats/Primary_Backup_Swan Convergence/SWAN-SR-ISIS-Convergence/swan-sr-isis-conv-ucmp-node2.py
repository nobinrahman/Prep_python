...
class Convergence_Test_UCMPv4_4k_Node2(aetest.Testcase):
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Default_ALL_NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Default_ALL_NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Scavenger_ALL_NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28104-28107 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(600)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Scavenger_ALL_NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit both classes_NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit both classes_NH","No Shut"] + get_values_swan(test_data))
