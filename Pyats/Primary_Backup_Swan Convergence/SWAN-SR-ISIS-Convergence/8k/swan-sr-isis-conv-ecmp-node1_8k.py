...
def get_drop_duration_drv(test_data):
    ...
    if not drv_worst:    
        ...
        select_properties = ['StreamBlock.Name', 
                             ...
                             'StreamBlock.Agg.DroppedFrameDuration', 
                             'StreamBlock.Agg.FrameLossDuration',
        ...
        stc.config(drvResultQ, SelectProperties=select_properties, 
                               ...
                               SortBy="{StreamBlock.Frameloss DESC}",
    ...
    if not drv_best:    
        ...
        stc.config(drvResultQ, SelectProperties=select_properties, 
                               WhereConditions=conditions, 
                               SortBy="{StreamBlock.Frameloss ASC}",  
                               FromObjects=streamblock_list, 
                               DisableAutoGrouping=False)
        # To subscribe to DRV
...
def get_values_swan(test_data):
    ...
    for result in get_drop_duration_drv(test_data):
        ...
        duration_agg = float(result["StreamBlock.Agg.FrameLossDuration"])
    ...
    log.info('####T19:' + T19)
    Aggrigate = float(duration_agg) / 1000000
...
class Convergence_Test_ECMPv4_4k_Node1(aetest.Testcase):
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        for loop in range(int(self.loop)):
            ...
            self.controller.execute('gzip -c /root/CBF_Only/734-40/OWR-734-50/D18-4NH-1000CBF-V4+V6-V4-ECMP.xml | curl -s -X POST http://172.25.124.54:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')
            ...
            self.controller.execute('gzip -c /root/MBB_MASTER/MIXED/ECMP/OWR1/OWR1_D8WAN_SLICE_ECMP_V4V6NH_8K.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')            
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Primary_NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Primary_NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_Primary_2NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Primary_2NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Ingress_Default_Primary_4NH"))
            module_args = {}
            module_args['timeout'] = 300
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']: 
            data_swan.append(["Ingress_Default_Primary_4NH","Shut"] + get_values_swan(test_data))
            data_isis.append(["Ingress_Default_Primary_4NH","Shut"] + get_values_isis(test_data))
            data_rsvp.append(["Ingress_Default_Primary_4NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_Primary_4NH","No Shut"] + get_values_swan(test_data))
            data_isis.append(["Ingress_Default_Primary_4NH","No Shut"] + get_values_isis(test_data))
            data_rsvp.append(["Ingress_Default_Primary_4NH","No Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28004 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28004 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(600)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_NH","NoShut"] + get_values_swan(test_data))
            data_isis.append(["Ingress_Scavenger_Primary_NH","NoShut"] + get_values_isis(test_data))
            data_rsvp.append(["Ingress_Scavenger_Primary_NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Ingress_Scavenger_Primary_4NH"))
            module_args = {}
            module_args['timeout'] = 300
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_4NH","Shut"] + get_values_swan(test_data))
            data_isis.append(["Ingress_Scavenger_Primary_4NH","Shut"] + get_values_isis(test_data))
            data_rsvp.append(["Ingress_Scavenger_Primary_4NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_Primary_4NH","NoShut"] + get_values_swan(test_data))
            data_isis.append(["Ingress_Scavenger_Primary_4NH","NoShut"] + get_values_isis(test_data))
            data_rsvp.append(["Ingress_Scavenger_Primary_4NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_8NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_8NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_ALL_Default_Primary_6NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_ALL_Default_Primary_6NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Backup_ALL_2NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Backup_ALL_2NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_Backup_ALL_2NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_Backup_ALL_2NH","NoShut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Backup_ALL_4NH","Shut"] + get_values_swan(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Backup_ALL_4NH","NoShut"] + get_values_swan(test_data))
