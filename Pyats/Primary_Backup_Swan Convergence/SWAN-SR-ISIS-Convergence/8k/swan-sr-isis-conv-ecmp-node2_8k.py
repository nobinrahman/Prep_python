...
###################################################################################################
    # 1) Print the number of elements
    num_elements = len(flowrsvp_sort)
    log.info('Number of Element in list: %s' %num_elements)

    avg = sum(flowrsvp_sort) / num_elements
    log.info('Avg of the list: %s' %flowrsvp_sort)

    Aggrigate = float(avg) / 1000000
###################################################################################################    
