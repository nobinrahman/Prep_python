...
class Convergence_Test_ECMPv4_4k_Node1(aetest.Testcase):
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            file_path_swan = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ecmp_node1_swan.csv"
            ...
            # file_path_isis = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ecmp_node1_isis.csv"
            ...
            # file_path_rsvp = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ecmp_node1_rsvp.csv"
