...
def get_drop_duration_drv(test_data):
    ...
    ####default
    streamblocknames = ['D18WAN-D12W-BGP-NH-V4-SWAN-Default-Exp0-C-RWA-D',
                        'D18WAN-D12W-BGP-NH-V6-SWAN-Default-Exp0-C-RWA-D']
    ...
    ####scavenger
    streamblocknames = ['D18WAN-D12W-BGP-NH-V4-SWAN-Scavenger-Exp1-C-RWA-D',
                        'D18WAN-D12W-BGP-NH-V6-SWAN-Scavenger-Exp1-C-RWA-D']
    for streamblock in streamblocknames:
        for sb in streamblock_list:
            if stc.get(sb, 'Name') == streamblock:
                break
    ...
    ####srv4
    streamblocknames = ['D18WAN-D8W2-ISIS-SR-Labeled-V4-Convergence',
                        'D18WAN-D12W-ISIS-SR-Labeled-V4-Convergence']
    for streamblock in streamblocknames:
        for sb in streamblock_list:
            if stc.get(sb, 'Name') == streamblock:
                break
    ...
    ####srv6
    streamblocknames = ['D18WAN-D12W-ISIS-SR-Labeled-V6-Convergence',
                        'D18WAN-D8W2-ISIS-SR-Labeled-V6-Convergence']
    for streamblock in streamblocknames:
        for sb in streamblock_list:
            if stc.get(sb, 'Name') == streamblock:
                break
    ...
    ####[BEST,AVG,WORST]
    returnDict = {}
    returnDict['default'] = [str(ret['default'][0]),str("{:.3f}".format(mean(ret['default']))),str(ret['default'][-1])]
...
def get_values(test_data):
    ...
    drop_duration_data = get_drop_duration_drv(test_data)
...
def get_values_non_zero(test_data):
    ...
    sorted_default = [value for value in drop_duration_data['default'] if value != 0.0]
    sorted_scavenger = [value for value in drop_duration_data['scavenger'] if value != 0.0]
    sorted_srv4 = drop_duration_data['srv4']
    sorted_srv6 = drop_duration_data['srv6']
    sorted_rsvp = drop_duration_data['rsvp']
...
class Convergence_Test_UCMPv4_4k_Node1(aetest.Testcase):
    global coredump_list, showtech_list, interface_list
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        for loop in range(int(self.loop)):
            ...
            self.controller.execute('gzip -c /root/MBB_MASTER/PRIMARY_BACKUP_MIXED/UCMP/OWR1/OWR1_D8WAN_SLICE_UCMP.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')            
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            #data_isis.append(["Ingress_Default_Primary_NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_Primary_NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            #data_isis.append(["Ingress_Default_Primary_NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_Primary_NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_Primary_2NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_Primary_2NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_Primary_2NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Primary_2NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_Primary_2NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_Primary_2NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_NH","Shut"] + get_values_non_zero(test_data))
            #data_isis.append(["Ingress_Scavenger_Primary_NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_Primary_NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_NH","No Shut"] + get_values_non_zero(test_data))
            #data_isis.append(["Ingress_Scavenger_Primary_NH","No Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_Primary_NH","No Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_2NH","Shut"] + get_values(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Scavenger_Primary_2NH","NoShut"] + get_values(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Primary_4NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Primary_4NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Primary_4NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Primary_4NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Primary_4NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Primary_4NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_4NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_4NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_4NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_4NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_4NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_4NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_4NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Scavenger_4NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_4NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_4NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Scavenger_4NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_4NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_8NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_8NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_8NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_8NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_8NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_8NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28000-28005 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(600)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_ALL_Scavenger_Primary_6NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_ALL_Default_Primary_6NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Scavenger_ALL_Default_Primary_6NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_ALL_Default_Primary_6NH ","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_ALL_Default_Primary_6NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Scavenger_ALL_Default_Primary_6NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_ALL_Default_Primary_6NH ","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28004-28005 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Backup_ALL_2NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_Backup_ALL_2NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_Backup_ALL_2NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Backup_ALL_2NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Default_Backup_ALL_2NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Default_Backup_ALL_2NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_Backup_ALL_2NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Scavenger_Backup_ALL_2NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_Backup_ALL_2NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Scavenger_Backup_ALL_2NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Scavenger_Backup_ALL_2NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Scavenger_Backup_ALL_2NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28004-28007 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Backup_ALL_4NH","Shut"] + get_values(test_data))
            #data_isis.append(["Ingress_Backup_ALL_4NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Backup_ALL_4NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Backup_ALL_4NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Ingress_Backup_ALL_4NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Ingress_Backup_ALL_4NH","NoShut"] + get_values_rsvp(test_data))
            ...
            log.info(banner("UCMP Ingress Node SWAN Convergence"))
            log.info(table_grid)

            file_path_swan = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ucmp_node1_swan.csv"
            ...
            # log.info(banner("UCMP Ingress Node ISIS Convergence"))
            # log.info(table_grid)

            # file_path_isis = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ucmp_node1_isis.csv"
            ...
            # log.info(banner("UCMP Ingress Node RSVP Convergence"))
            # log.info(table_grid)

            # file_path_rsvp = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ucmp_node1_rsvp.csv"
