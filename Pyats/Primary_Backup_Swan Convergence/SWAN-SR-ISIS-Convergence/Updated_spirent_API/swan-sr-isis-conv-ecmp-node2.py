...
class Convergence_Test_ECMPv4_4k_Node2(aetest.Testcase):
    global coredump_list, showtech_list, interface_list
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            file_path_swan = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ecmp_node2_swan.csv"
            ...
            # log.info(banner("ECMP Transit Node ISIS Convergence"))
            # log.info(table_grid)

            # file_path_isis = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ecmp_node2_isis.csv"
            ...
            # log.info(banner("ECMP Transit Node RSVP Convergence"))
            # log.info(table_grid)

            # file_path_rsvp = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ecmp_node2_rsvp.csv"
