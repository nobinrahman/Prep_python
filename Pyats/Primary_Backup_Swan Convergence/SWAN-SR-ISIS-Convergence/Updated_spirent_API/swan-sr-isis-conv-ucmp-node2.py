...
class Convergence_Test_UCMPv4_4k_Node2(aetest.Testcase):
    global coredump_list, showtech_list, interface_list
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Transit class-Default_ALL_NH"))
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28100-28101,28104-28105 shutdown"]
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Default_ALL_NH","Shut"] + get_values(test_data))
            #data_isis.append(["Transit class-Default_ALL_NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Transit class-Default_ALL_NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28100-28101,28104-28105 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(600)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Default_ALL_NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Transit class-Default_ALL_NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Transit class-Default_ALL_NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Transit class-Scavenger_ALL_NH"))
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28102-28103,28106-28107 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Scavenger_ALL_NH","Shut"] + get_values(test_data))
            #data_isis.append(["Transit class-Scavenger_ALL_NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Transit class-Scavenger_ALL_NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28102-28103,28106-28107 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(600)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit class-Scavenger_ALL_NH","NoShut"] + get_values(test_data))
            #data_isis.append(["Transit class-Scavenger_ALL_NH","NoShut"] + get_values_isis(test_data))
            #data_rsvp.append(["Transit class-Scavenger_ALL_NH","NoShut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Transit both classes_NH"))
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28100-28107 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit both classes_NH","Shut"] + get_values(test_data))
            #data_isis.append(["Transit both classes_NH","Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Transit both classes_NH","Shut"] + get_values_rsvp(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28100-28107 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(600)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Transit both classes_NH","No Shut"] + get_values(test_data))
            #data_isis.append(["Transit both classes_NH","No Shut"] + get_values_isis(test_data))
            #data_rsvp.append(["Transit both classes_NH","No Shut"] + get_values_rsvp(test_data))
            ...
            log.info(banner("UCMP Transit Node SWAN Convergence"))
            log.info(table_grid)

            file_path_swan = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ucmp_node2_swan.csv"
            ...
            # log.info(banner("UCMP Transit Node ISIS Convergence"))
            # log.info(table_grid)

            # file_path_isis = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ucmp_node2_isis.csv"
            ...
            # log.info(banner("UCMP Transit Node RSVP Convergence"))
            # log.info(table_grid)

            # file_path_rsvp = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/ucmp_node2_rsvp.csv"
