...
class Profile4_UCMP(aetest.Testcase):
    global coredump_list, showtech_list, interface_list
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        for loop in range(int(self.loop)):
            ...
            self.controller.execute('cd /root/MBB_MASTER/MIXED && ./profile4_ucmp.sh', timeout = 300)
            time.sleep(30)            
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Ingress_Default_Backup_NH"))
            module_args = {}
            module_args['timeout'] = 300
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_Backup_NH","Shut"] + get_values_non_zero(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Backup_NH","NoShut"] + get_values_non_zero(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Ingress_Default_Backup_All_3NHs"))
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["interface Bundle-Ether 28001,28002,28003 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_Backup_All_3NHs","Shut"] + get_values_non_zero(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            module_args = {}
            module_args['timeout'] = 300
            module_args['sste_commands'] = ["no interface Bundle-Ether 28001,28002,28003 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(100)
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            data_swan.append(["Ingress_Default_Backup_All_3NHs","NoShut"] + get_values_non_zero(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Primary_Backup_2NHs","No Shut"] + get_values_non_zero(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            ###################### SHUT_INTERFACE ######################
            log.info(banner("Ingress_Default_All_4NHs"))
            module_args = {}
            module_args['timeout'] = 300
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            data_swan.append(["Ingress_Default_All_4NHs","Shut"] + get_values_non_zero(test_data))
        ...
        if 'tgn' in test_data and 'spirent' == test_data['tgn']:
            ...
            log.info(banner("Profile4_UCMP_SWAN_Convergence"))
            log.info(table_grid)

            file_path_swan = "/scratch/msftcvtauto/WAN/SWAN/CONVERGENCE/Logs/profile4_ucmp.csv"
