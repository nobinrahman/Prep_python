...
class interface_flapping(aetest.Testcase):
    ...
    def interface_flapping(self, steps, script_args, testbed, test_data, timing):
        ...
        module_args = {}
        module_args['timeout'] = 300
        module_args['sste_commands'] = '["show interface Bundle-Ether 8400 brief"]'
        output = sste_common.exec_commands(module_args, script_args)
        if output.count('up'):
            pass
        else:
        ...
        module_args = {}
        module_args['timeout'] = 300
        module_args['sste_commands'] = '["show interface Bundle-Ether 8401 brief"]'
        output = sste_common.exec_commands(module_args, script_args)
        if output.count('up'):
            pass
        else:
        ...
        module_args = {}
        module_args['timeout'] = 300
        module_args['sste_commands'] = '["show interface Bundle-Ether 8402 brief"]'
        output = sste_common.exec_commands(module_args, script_args)
        if output.count('up'):
            pass
        else:
        ...
        module_args = {}
        module_args['timeout'] = 300
        module_args['sste_commands'] = '["show interface Bundle-Ether 8403 brief"]'
        output = sste_common.exec_commands(module_args, script_args)
        if output.count('up'):
            pass
        else:
        ...
        module_args = {}
        module_args['timeout'] = 300
        module_args['sste_commands'] = '["show interface Bundle-Ether 21000 brief"]'
        output = sste_common.exec_commands(module_args, script_args)
        if output.count('up'):
            pass
        else:
        ...
        module_args = {}
        module_args['timeout'] = 300
        module_args['sste_commands'] = '["show interface Bundle-Ether 4100 brief"]'
        output = sste_common.exec_commands(module_args, script_args)
        if output.count('up'):
            pass
        else:
        ...
        module_args = {}
        module_args['timeout'] = 300
        module_args['sste_commands'] = '["show interface Bundle-Ether 4101 brief"]'
        output = sste_common.exec_commands(module_args, script_args)
        if output.count('up'):
            pass
        else:
        ...
        for loop in range(int(self.loop)):
            ...
            module_args = {}
            module_args['timeout'] = 300
            #module_args['sste_commands'] = ["interface bundle-Ether 8400-8403 shutdown"]
            module_args['sste_commands'] = ["interface bundle-Ether 8400-8403,21000,4100-4101 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(90)

#            module_args = {}
#            module_args['timeout'] = 300
#            module_args['sste_commands'] = ["interface bundle-Ether 21000 shutdown"]
#            output = sste_common.config_commands(module_args, script_args)
#            time.sleep(90)
#
#
#            module_args = {}
#            module_args['timeout'] = 300
#            module_args['sste_commands'] = ["interface bundle-Ether 4100-4101 shutdown"]
#            output = sste_common.config_commands(module_args, script_args)
#            time.sleep(90)
...
#            module_args = {}
#            module_args['timeout'] = 300
#            module_args['sste_commands'] = ["no interface bundle-Ether 8400-8403 shutdown"]
#            output = sste_common.config_commands(module_args, script_args)
#            time.sleep(90)
#
#            module_args = {}
#            module_args['timeout'] = 300
#            module_args['sste_commands'] = ["no interface bundle-Ether 21000 shutdown"]
#            output = sste_common.config_commands(module_args, script_args)
#            time.sleep(90)
            ...
            module_args = {}
            module_args['timeout'] = 300
            #module_args['sste_commands'] = ["no interface bundle-Ether 4100-4101 shutdown"]
            module_args['sste_commands'] = ["no interface bundle-Ether 8400-8403,21000,4100-4101 shutdown"]
            output = sste_common.config_commands(module_args, script_args)
            time.sleep(300)
        ...
        if output.count('up'):
            ...
            show_tech(script_args)
            self.failed("interface is not after loop flapping")
        ...
        if output.count('up'):
            ...
            show_tech(script_args)
            self.failed("interface is not up after loop flapping")
        ...
        if output.count('up'):
            ...
            show_tech(script_args)
            self.failed("interface is not up after flapping in loop")
        ...
        log.info('Waiting 5 minutes for all the traffic to converge')
        time.sleep(300)
