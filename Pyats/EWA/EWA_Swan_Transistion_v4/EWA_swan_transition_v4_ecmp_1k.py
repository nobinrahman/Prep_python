...
def V4_Controller(failed, steps, script_args, testscript, testbed, test_data, timing):
    ...
    controller.execute('gzip -c /root/MBB_MASTER/EXPLICIT_NULLV6_D18-4NH-500V4-500V6-to-250-V6-V4-ECMP.xml | curl -s -X POST http://172.25.124.54:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;', timeout = 300)
    time.sleep(2)
    ...
    time.sleep(2)
    controller.execute('gzip -c /root/MBB_MASTER/MIXED/ECMP/OWR1/OWR1_D8WAN_SLICE_ECMP.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;', timeout = 300)
    time.sleep(60)
...
def V6_Controller(failed, steps, script_args, testscript, testbed, test_data, timing):
    ...
    controller.execute('gzip -c /root/MBB_MASTER/EXPLICIT_NULLV6_D18-4NH-500V4-500V6-to-250-V6-V4-ECMP.xml | curl -s -X POST http://172.25.124.54:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')
    time.sleep(2)
    ...
    time.sleep(2)
    controller.execute('gzip -c /root/MBB_MASTER/MIXED/ECMP/OWR1/OWR1_D8WAN_SLICE_ECMP.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;')
    time.sleep(60)
    controller.disconnect()
...
def Verifier_Before(failed, steps, script_args, testscript, testbed, test_data, timing):
    ...
    log.info(banner("Checking 1k Labels"))
    counter = 0
    while 1:
...
class TC1_CONTINUOUS_SWAN_PROGRAMMING(aetest.Testcase):
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        for beloop in range(int(self.beloop)):
            ...
            time.sleep(1)
            self.controller.execute('gzip -c /root/MBB_MASTER/MIXED/ECMP/OWR1/OWR1_D8WAN_SLICE_ECMP.XML | curl -s -X POST http://172.25.124.52:10000/flowtable -H "Content-Type:text/xml" -H "Content-Encoding: gzip" --data-binary @-; echo;', timeout = 300)
            time.sleep(1)
...
class TC24_SWAN_AGENT_RESTART(aetest.Testcase):
    ...
    def Node1_trigger(self, steps, script_args, testscript,testbed, test_data, timing):
        ...
        for loop in range(int(self.loop)):
            ...
            log.info(banner("TC23.0-SWAN Agent Reload"))
